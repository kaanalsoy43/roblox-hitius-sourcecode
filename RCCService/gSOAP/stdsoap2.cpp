...
#ifdef __cplusplus
SOAP_SOURCE_STAMP("@(#) stdsoap2.cpp ver 2.7.10 2008-01-27 00:00:00 GMT")
extern "C" {
#else
SOAP_SOURCE_STAMP("@(#) stdsoap2.c ver 2.7.10 2008-01-27 00:00:00 GMT")
#endif
...
{ register int r;
  ...
  if (soap->is)
  { if (soap->is->good())
	// BEGIN ROBLOX CHANGE: Add size_t cast to silence compiler warning
