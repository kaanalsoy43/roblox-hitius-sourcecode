...
// ROBLOX: moved from private to public
    /**
...
// ROBLOX
	static bool rotateAndPasteSubImage(
		...
		int destX, int destY, int srcX, int srcY, int srcWidth, int srcHeight, int rotation);
