...
public:
    ...
    // Special values.
    // Inlined, see Matrix3::identity() for details.
    static const Vector2& one()       { static const Vector2 v(1, 1); return v; }
    static const Vector2& zero()      { static Vector2 v(0, 0); return v; }
    static const Vector2& unitX()     { static Vector2 v(1, 0); return v; }
    static const Vector2& unitY()     { static Vector2 v(0, 1); return v; }
    static const Vector2& inf()       { static Vector2 v((float)G3D::finf(), (float)G3D::finf()); return v; }
    static const Vector2& nan()       { static Vector2 v((float)G3D::fnan(), (float)G3D::fnan());  return v; }
    /** smallest (most negative) representable vector */
    static const Vector2& minFinite() { static Vector2 v(-FLT_MAX, -FLT_MAX);  return v; }
    /** Largest representable vector */
    static const Vector2& maxFinite() { static Vector2 v(FLT_MAX, FLT_MAX); return v; }
