...
public:
    ...
    explicit Vector3(const float coordinate[3]);
    explicit Vector3(const double coordinate[3]);
    explicit Vector3(const class Vector3int16& v);
    ...
    Vector3int16 toVector3int16() const;
...
// ROBLOX
	...
	static void generateStableOrthonormalBasis (Vector3& rkU /*tangent*/, Vector3& rkV /*binormal*/,
												Vector3& rkW /*normal*/, bool bUnitLengthW = true);
...
//=====
    ...
    static const Vector3& inf()      { static const Vector3 v((float)G3D::finf(), (float)G3D::finf(), (float)G3D::finf()); return v; }
    static const Vector3& nan()      { static const Vector3 v((float)G3D::fnan(), (float)G3D::fnan(), (float)G3D::fnan()); return v; }
    /** Smallest (most negative) representable vector */
    static const Vector3& minFinite(){ static const Vector3 v(-FLT_MAX, -FLT_MAX, -FLT_MAX); return v; }
    /** Largest representable vector */
    static const Vector3& maxFinite(){ static const Vector3 v(FLT_MAX, FLT_MAX, FLT_MAX); return v; }
...
//----------------------------------------------------------------------------
inline Vector3::Vector3 (const double V[3]) : x((float)V[0]), y((float)V[1]), z((float)V[2]){
}
